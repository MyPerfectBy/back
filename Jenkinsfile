            ...
            steps {
                script {
                        try {
                            ...
                            sh "curl 'https://api.telegram.org/bot705294643:AAGnXC6EzmrpXU4USD6uxq7U1Qt853s4ciY/sendMessage?chat_id=-211246197@Avakada_CI&text=${e}&parse_mode=HTML'"
                            throw ex
                        }
                    }
            }
        ...
        stage('Notification') {
            steps {
                script {
                    ...
                    sh "curl 'https://api.telegram.org/bot705294643:AAGnXC6EzmrpXU4USD6uxq7U1Qt853s4ciY/sendMessage?chat_id=-211246197@Avakada_CI&text=${mes}&parse_mode=HTML'"
                }
            }
        }
    }
